...
| **`focused-window-border.ps1`** | [scripts/focused-window-border.ps1](file:///%USERPROFILE%/Documents/myenv/scripts/focused-window-border.ps1) | سكريبت PowerShell سابق لإطار النافذة (تم استبداله بمحرك `tools/tacky-borders/tacky-borders.exe` المكتوب بلغة Rust لسرعة فائقة و100% Click-through). |
