...
| **`install-len.ps1`** | [scripts/install-len.ps1](file:///%USERPROFILE%/Documents/myenv/scripts/install-len.ps1) | **المثبت التلقائي الذكي لأداة len (ProjectLens)**؛ يقوم بفحص أحدث نسخة ومطابقة الـ Commit من مستودع GitHub وتثبيتها/ترقيتها تلقائياً بدون تكرار في حال كانت مثبتة ومحدثة. |
