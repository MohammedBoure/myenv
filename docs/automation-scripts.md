...
PowerShell and batch scripts automating environment setup, registry configurations, developer tool restoration, and hotkey actions.
...
| `install-clink.ps1` | [scripts/install-clink.ps1](file:///%USERPROFILE%/Documents/myenv/scripts/install-clink.ps1) | Installs Clink via WinGet and configures CMD AutoRun. |
| `set-cmd-autocompletion.ps1` | [scripts/set-cmd-autocompletion.ps1](file:///%USERPROFILE%/Documents/myenv/scripts/set-cmd-autocompletion.ps1) | Configures CMD Tab completion and AutoRun script. |
| `set-taskbar-autohide.ps1` | [scripts/set-taskbar-autohide.ps1](file:///%USERPROFILE%/Documents/myenv/scripts/set-taskbar-autohide.ps1) | Toggles Windows Taskbar autohide in Registry and restarts Explorer. |
...
| `disable-alt-shift-lang.ps1` | [scripts/disable-alt-shift-lang.ps1](file:///%USERPROFILE%/Documents/myenv/scripts/disable-alt-shift-lang.ps1) | Disables `Alt+Shift` key toggle, keeping `Win+Space` as primary input switcher. |
...
| `smart-tiling-direction.ps1` | [scripts/smart-tiling-direction.ps1](file:///%USERPROFILE%/Documents/myenv/scripts/smart-tiling-direction.ps1) | Listens to GlazeWM events and automatically sets tiling split direction. |
| `setup-arabic-terminal.ps1` | [scripts/setup-arabic-terminal.ps1](file:///%USERPROFILE%/Documents/myenv/scripts/setup-arabic-terminal.ps1) | Arabic Terminal and UTF-8 Setup: Centralizes Windows Terminal settings, enforces UTF-8 CodePage 65001, Cascadia Mono font, and compiles `open-terminal-here.exe`. |
...
| `install-lensbridge.ps1` | [scripts/install-lensbridge.ps1](file:///%USERPROFILE%/Documents/myenv/scripts/install-lensbridge.ps1) | LensBridge Server Auto-Installer: Automates repository sync (`D:\git\LensBridge`), isolated venv creation, requirements installation, and background service setup. |
| `OpenTerminalHere.cs` / `.exe` | [scripts/OpenTerminalHere.cs](file:///%USERPROFILE%/Documents/myenv/scripts/OpenTerminalHere.cs) | Instant C# launcher to open Windows Terminal / CMD / PowerShell at active Explorer path (<10ms). |
...
| `download-clink.ps1` | [scripts/download-clink.ps1](file:///%USERPROFILE%/Documents/myenv/scripts/download-clink.ps1) | Downloads and installs portable Clink zip release if WinGet fails. |
...
| `capture-screenshot.ps1` | [scripts/capture-screenshot.ps1](file:///%USERPROFILE%/Documents/myenv/scripts/capture-screenshot.ps1) | Direct full screenshot capture to file and Clipboard (`Alt+Shift+S`). |
...
| `cb.cmd` | [scripts/cb.cmd](file:///%USERPROFILE%/Documents/myenv/scripts/cb.cmd) | Output display and clipboard copy wrapper script. |
