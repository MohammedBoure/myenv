...
| **`focused-window-border.ps1`** | [scripts/focused-window-border.ps1](file:///%USERPROFILE%/Documents/myenv/scripts/focused-window-border.ps1) | Legacy Win32/WPF active window focus border (superseded by native `tools/tacky-borders/tacky-borders.exe`) |
