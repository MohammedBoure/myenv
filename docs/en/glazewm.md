...
|---|---|
| `Alt + H` / `Alt + ←` | Focus window on the left |
| `Alt + L` / `Alt + →` | Focus window on the right |
| `Alt + K` / `Alt + ↑` | Focus window above |
| `Alt + J` / `Alt + ↓` | Focus window below |
...
### 🖥️ Workspaces & Multi-Monitor Setup
