...
/// <summary>
/// Model representing a quick symbol, snippet, or frequently used word.
/// </summary>
...
/// <summary>
/// Service managing persistent storage and defaults for quick symbols and frequently used words.
/// </summary>
public static class QuickSymbolService
{
    ...
    /// <summary>
    /// Loads symbols from persistent JSON storage, creating default presets if not found.
    /// </summary>
    public static List<QuickSymbolItem> LoadItems()
    {
        ...
        {
            // Fallback to default items upon deserialization errors
        }
    ...
    /// <summary>
    /// Persists symbols to disk as formatted JSON.
    /// </summary>
    public static void SaveItems(List<QuickSymbolItem> items)
    {
        ...
        {
            // Resilient against system write restrictions
        }
    }

    /// <summary>
    /// Default presets covering arrows, math, bullets, typography, snippets, and Arabic expressions.
    /// </summary>
