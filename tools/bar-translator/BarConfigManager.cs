...
namespace BarTranslator {
    ...
    public static class BarConfigManager {
        ...
        public static readonly List<BarWidgetInfo> AllWidgets = new() {
            ...
            new BarWidgetInfo { Id = "translator_speak", Name = "Pronounce English Button", Icon = "🎙️", Section = "center", DefaultOrder = 0 },
            new BarWidgetInfo { Id = "translator", Name = "Translator Text Frame", Icon = "🔤", Section = "center", DefaultOrder = 1 },
            new BarWidgetInfo { Id = "clock", Name = "Clock & Date", Icon = "🕒", Section = "center", DefaultOrder = 2 },
