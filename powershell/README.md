...
| [`console-theme.ps1`](file:///C:/Users/moham/Documents/myenv/powershell/console-theme.ps1) | Console window and terminal theming script applying 32% transparency (68% opacity), true black background, and Midnight Aurora palette across both classic Windows Console (`conhost.exe`) and Windows 11 Windows Terminal (`wt.exe`). |
